...
title=SEResNet34_base_Wav2Vec2_ASP_v2-VB_paste_real
cmd="--title ${title} --model Spade --device cuda --batch 1         \
     --model_conf config/model/SEResNet34_base_Wav2Vec2_ASP_v2.yaml \
     --hyper_conf config/hyper/Spade_VB_paste_real.yaml             \
     --params exp/${title}/checkpoints/best_valid_score.pt"
